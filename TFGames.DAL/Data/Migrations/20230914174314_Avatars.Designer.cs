...
namespace TFGames.DAL.Data.Migrations
{
    ...
    [Migration("20230914174314_Avatars")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TFGames.Common.Entities.ArticleTags", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TFGames.Common.Entities.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TFGames.Common.Entities.Tags", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TFGames.Common.Entities.ArticleTags", b =>
                {
                    ...
                    b.HasOne("TFGames.Common.Entities.Tags", "Tag")
                        .WithMany("Articles")
                        .HasForeignKey("TagId");
            ...
            modelBuilder.Entity("TFGames.Common.Entities.Favorite", b =>
                {
                    ...
                    b.HasOne("TFGames.Common.Entities.User", "User")
                        .WithMany("Favorites")
                        .HasForeignKey("UserId");
